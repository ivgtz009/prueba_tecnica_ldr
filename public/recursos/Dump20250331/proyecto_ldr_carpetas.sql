...
CREATE TABLE `carpetas` (
  ...
  `carpeta_nombre` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_carpeta`),
  KEY `id_area` (`id_area`),
  CONSTRAINT `carpetas_ibfk_1` FOREIGN KEY (`id_area`) REFERENCES `areas` (`id_area`),
  CONSTRAINT `carpetas_ibfk_2` FOREIGN KEY (`id_area`) REFERENCES `areas` (`id_area`)
...
INSERT INTO `carpetas` VALUES (10,NULL,8,'prueba_009');
