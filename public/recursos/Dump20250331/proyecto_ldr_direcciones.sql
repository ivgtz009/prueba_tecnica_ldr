...
CREATE TABLE `direcciones` (
  ...
  `direccion_nombre` varchar(50) DEFAULT NULL,
...
INSERT INTO `direcciones` VALUES (1,1,'Ciudad de Mexico'),(2,1,'Queretaro'),(3,2,'Naucalpan'),(4,2,'Polanco'),(5,2,'Jalisco'),(6,3,'Ciudad de Mexico');
